    ...
    <Card>
      ...
      <Card>
        ...
        <Row class="top">
          ...
          <Col span="4">
          <DatePicker :value='data.stirStartTime' type="datetime" format="yyyy-MM-dd HH:mm" @on-change="data.stirStartTime=$event"
            placeholder="Select time" style="width: 100%"></DatePicker>

          </Col>
          <Col span="3" offset="1" class="intro">结束搅拌时间:</Col>
          <Col span="4">
          <DatePicker :value='data.stirEndTime' type="datetime" format="yyyy-MM-dd HH:mm" @on-change="data.stirEndTime=$event"
            placeholder="Select time" style="width: 100%"></DatePicker>
            ...
            <table style="width:100%;text-align: center;" border="1" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td v-for='item in data.detTime'>
                  <TimePicker :value="item.detTime" format="HH:mm" @on-change="item.detTime=$event" placeholder="Select time"
        ...
        <Card>
          ...
          <Row class="top">
            ...
            <DatePicker type="datetime" format="yyyy-MM-dd HH:mm" :value="data.restEndTime" @on-change="data.restEndTime=$event"
              placeholder="结束静置时间" style="width: 100%"></DatePicker>
            </Col>
            <Col span="2" offset="1" class="intro">班次:</Col>
            <Col span="5">
